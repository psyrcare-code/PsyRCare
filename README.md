...
<!-- Main content -->
<div id="mainContent">
  <div id="bookingTitle">Find the session that resonates with you</div>
  <div id="bookingSub">A calm space to begin your journey</div>
...
let welcomeText = "Welcome to PsyRCare. This space was created for your calm and clarity.";
let i = 0;

function typeWelcome() {
  if (i < welcomeText.length) {
    welcomeBox.innerHTML += welcomeText.charAt(i);
    i++;
    setTimeout(typeWelcome, 45);
  } else {
    setTimeout(() => {
      intro.style.display = "none";   // hide name + welcome
      mainContent.style.display = "block"; // show offers
    }, 1200);
  }
}
