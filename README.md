    ...
    <div class="offer-card">
      ...
      <button class="book-btn"
        onclick="bookOffer(
          '2 Hours Session',
          '2 hours',
          'A longer space for clarity, reflection, and awareness.',
          20
        )">Book</button>
    </div>
    ...
    <div class="offer-card">
      ...
      <button class="book-btn"
        onclick="bookOffer(
          '3 Hours Session',
          '3 hours',
          'A complete session for profound reflection and clarity.',
          30
        )">Book</button>
    </div>
...
<script>
// ✅ الاسم الحقيقي القادم من register.html
